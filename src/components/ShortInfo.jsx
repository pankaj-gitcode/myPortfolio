    ...
    return(<>
        ...
        '>
            <h1 className='animTxt font-[font4] lg:text-[3vw]'>
                I AM
                <span id='animTxtDev' className=' text-black font-[font3] text-shdow'> PANKAJ ADITYA </span>
                <span className='animTxt font-[font4] lg:text-7xl lg:text-[3vw]'><br/>FRONTEND </span>
                <span className='animTxt text-[5vw]'><br/>DEVELOPER <span  className=' text-white txt-shadow-black'>™</span></span>
